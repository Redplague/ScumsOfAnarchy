...
do
  ...
  then
          ...
          KDRATIO_UPDATE_DEATH=`mysql -BNe "select kdratio from scumlogs.stats where steamid = '$DEATH_STEAM_ID' ;"`
          KDRATIO_UPDATE_KILL=`mysql -BNe "select kdratio from scumlogs.stats where steamid = '$KILL_STEAM_ID' ;"`
#          echo $KILL_STEAM_ID
#          echo $DEATH_STEAM_ID
